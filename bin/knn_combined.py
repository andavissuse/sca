...
def main(argv):
    ...
    for datatype_num in range(len(datatypes)):
        ...
        if DEBUG == "TRUE":
            print("*** DEBUG: " + sys.argv[0] + ": ids_scores:", ids_scores)
        total_ids_scores = total_ids_scores + ids_scores
        if DEBUG == "TRUE":
            print("*** DEBUG: " + sys.argv[0] + ": total_ids_scores:", total_ids_scores)

    new_total_ids_scores = []
    for id_score in total_ids_scores:
        if DEBUG == "TRUE":
            print("*** DEBUG: " + sys.argv[0] + ": id_score:", id_score)
        found = "FALSE" 
        ...
        if DEBUG == "TRUE":
            print("*** DEBUG: " + sys.argv[0] + ": new_total_ids_scores:", new_total_ids_scores)
    ...
    if DEBUG == "TRUE":
        print("*** DEBUG: " + sys.argv[0] + ": new_total_ids_score:", new_total_ids_scores)
